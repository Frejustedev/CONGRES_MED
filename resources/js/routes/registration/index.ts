...
/**
* @see \App\Http\Controllers\Public\RegistrationController::promoCheck
 * @see app/Http/Controllers/Public/RegistrationController.php:67
 * @route '/inscription/promo-check'
 */
export const promoCheck = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: promoCheck.url(options),
    method: 'post',
})

promoCheck.definition = {
    methods: ["post"],
 ...
 * @route '/inscription/promo-check'
 */
promoCheck.url = (options?: RouteQueryOptions) => {
    return promoCheck.definition.url + queryParams(options)
}
 ...
 * @route '/inscription/promo-check'
 */
promoCheck.post = (options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: promoCheck.url(options),
    method: 'post',
})
 ...
 * @route '/inscription/promo-check'
 */
    const promoCheckForm = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: promoCheck.url(options),
        method: 'post',
    })
 ...
 * @route '/inscription/promo-check'
 */
        promoCheckForm.post = (options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: promoCheck.url(options),
            method: 'post',
        })
    
    promoCheck.form = promoCheckForm
/**
...
promoCheck: Object.assign(promoCheck, promoCheck),
